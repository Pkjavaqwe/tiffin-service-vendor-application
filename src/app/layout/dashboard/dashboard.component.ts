...
export class DashboardComponent {
  ...
  pageSize = 10;
  currentPage = 0;
  cardHeight: number = 300; // Initial height of the card
  ...
  onRegisterClick(organizationId: string) {
    ...
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3M2VjOTE4MmMxNDVlYjUwOTJmZmZhZiIsInJvbGUiOiI2NzIzNDc1Zjc0YjMyY2ZlMzllNWQwYTIiLCJpYXQiOjE3MzI0NzIzMjAsImV4cCI6MTczMjQ3OTUyMH0.yNm8G7BJ_PzKkpG5bER9Syiu8V0iBaBn435GcdWY7fc';
